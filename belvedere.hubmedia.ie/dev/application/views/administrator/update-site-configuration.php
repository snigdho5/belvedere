                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input class="form-control" value="<?php echo $siteconfiguration['email']; ?>" placeholder="Email" name="email" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Phone</label>
                                                            <div class="col-sm-6">
                                                                <input class="form-control" value="<?php echo $siteconfiguration['phone']; ?>" placeholder="Phone" name="phone" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Address</label>
                                                            <div class="col-sm-6">
                                                                <textarea class="form-control" value="<?php echo $siteconfiguration['address']; ?>" placeholder="Address" name="address" type="text"><?php echo $siteconfiguration['address']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Short Bio</label>
                                                            <div class="col-sm-6">
                                                                <textarea class="form-control" value="<?php echo $siteconfiguration['short_bio']; ?>" placeholder="Short Bio" name="short_bio" type="text"><?php echo $siteconfiguration['short_bio']; ?></textarea>
                                                            </div>
                                                        </div>
                                                         <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Copyright Text</label>
                                                            <div class="col-sm-6">
                                                                <input class="form-control" value="<?php echo $siteconfiguration['copyright_text']; ?>" placeholder="Copyright Text" name="copyright_text" type="text">
                                                            </div>
                                                        </div>
