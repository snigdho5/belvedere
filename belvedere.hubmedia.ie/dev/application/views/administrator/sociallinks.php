            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Social links</a>
                        </li>
                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <?php foreach($sociallinks as $posts) : ?>
                                 <tr>
                                        ...
                                        <td><?php echo $posts['social_name']; ?></td>
                                        <td><?php echo $posts['link']; ?></td>
                                        <td><?php echo $posts['icon']; ?></td>
                                        <td>
                                            <a class="label label-inverse-info" href='<?php echo base_url(); ?>administrator/sociallinks/update/<?php echo $posts['id']; ?>'>Edit</a>
                                            <a class="label label-inverse-danger delete" href='<?php echo base_url(); ?>administrator/delete/<?php echo $posts['id']; ?>?table=<?php echo base64_encode('sociallinks'); ?>'>Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
