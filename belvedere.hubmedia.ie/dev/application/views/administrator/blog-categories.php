            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List Blog</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card-block">
                        <div class="table-responsive dt-responsive">
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                <?php foreach($blog_categories as $post) : ?>
                                 <tr>
                                        ...
                                        <td>
                                               ...
                                               <a class="label label-inverse-primary enable" href='<?php echo base_url(); ?>administrator/enable/<?php echo $post['id']; ?>?table=<?php echo base64_encode('categories'); ?>'>Enabled</a>
                                                ...
                                                <?php } ?>
                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>administrator/blog-categories/update/<?php echo $post['id']; ?>'>Edit</a>
