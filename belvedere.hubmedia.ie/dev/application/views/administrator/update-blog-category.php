            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Blog Category</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!">Update Blog Category</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/update_blog_category_data'); ?>
                               <input type="hidden" name="id" value="<?php echo $blogcategory['id']; ?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="name" value="<?php echo $blogcategory['name']; ?>" class="form-control" placeholder="Category Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="checkbox" value="1" name="status" class="js-single"
                                             <?php if($blogcategory['status'] == '1'){ echo "checked"; } ?> />
                                        </div>
                                    </div>
