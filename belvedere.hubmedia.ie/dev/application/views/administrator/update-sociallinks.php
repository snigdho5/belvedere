                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Title" value="<?php echo $sociallinks['social_name']; ?>" name="social_name" type="text" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" value="<?php echo $sociallinks['icon']; ?>" name="icon" placeholder="Icon" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
