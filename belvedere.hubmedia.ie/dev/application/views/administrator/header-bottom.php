<?php
 ...
 ?>
     ...
     <!-- Menu aside start -->
    <div class="main-menu" style="height: 100vh; background: #2f3133 !important;">
            ...
            <ul class="main-navigation">
             <li class="nav-item has-class">
                ...
                <li class="nav-item">
                        ...
                        <ul class="tree-1">
                            <li><a href="<?php echo base_url(); ?>administrator/site-configuration/update/1">Settings</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    <a href="#!">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?php echo base_url(); ?>administrator/sociallinks/create">Add Link</a></li>
                ...
                <li class="nav-item">
                        <a href="#!">
                            ...
                            <span data-i18n="nav.basic-components.main">Pages</span>
                        </a>
                        <ul class="tree-1">
                            <li><a href="<?php echo base_url(); ?>administrator/pages/create" data-i18n="nav.basic-components.alert">Add Page</a></li>
                            <li><a href="<?php echo base_url(); ?>administrator/pages" data-i18n="nav.basic-components.breadcrumbs">List Page</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="tree-1">
                            ...
                            <li class="nav-sub-item"><a href="#">Posts</a>
                                <ul class="tree-2">
                                    <li><a href="<?php echo base_url(); ?>administrator/blogs/add-blog">Add Post</a></li>
                                    <li><a href="<?php echo base_url(); ?>administrator/blogs/list-blog">List Posts</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="tree-1">
                            ...
                            <li class="nav-sub-item"><a href="#">Category</a>
                                <ul class="tree-2">
                                    <li><a href="<?php echo base_url(); ?>administrator/event-categories/create">Add Category</a></li>
                                    <li><a href="<?php echo base_url(); ?>administrator/event-categories">List Category</a></li>
                                </ul>
                            </li>
                            <li class="nav-sub-item"><a href="#">Events</a>
                                <ul class="tree-2">
                                    <li><a href="<?php echo base_url(); ?>administrator/events/create">Add Event</a></li>
                                    <li><a href="<?php echo base_url(); ?>administrator/events">List Events</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
