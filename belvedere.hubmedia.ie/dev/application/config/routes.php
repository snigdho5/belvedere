...
$route['administrator/pages/create'] = 'administrator/create_page';
$route['administrator/pages'] = 'administrator/get_pages';
$route['administrator/pages/update/(:any)'] = 'administrator/update_pages/$1';

$route['administrator/sociallinks'] = 'administrator/get_sociallinks';
$route['administrator/sociallinks/create'] = 'administrator/add_sociallinks';
...
$route['administrator/event-categories/create'] = 'administrator/create_event_category';
$route['administrator/event-categories/update/(:any)'] = 'administrator/update_event_category/$1';
$route['administrator/event-categories'] = 'administrator/event_categories';

$route['administrator/events/create'] = 'administrator/create_event';
$route['administrator/events'] = 'administrator/get_events';
$route['administrator/events/update/(:any)'] = 'administrator/update_events/$1';
