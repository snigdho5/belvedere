<div class="themesetting">
    ...
    <hr>
    <div>
        <a href="javascript:void(0);" class="btn btn-dark btn-block">Buy this item</a>
        <a href="javascript:void(0);" class="btn btn-primary theme-bg btn-block">View Portfolio</a>
    </div>
</div>