...
<header class="xt-head-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="xt-pre-header-left-content"><span class="xt-business-email"><i class="sli-paper-plane"></i><a href="mailto:{{$email}}">{{$email}}</a></span> <span class="xt-business-phone"><i class="sli-phone"></i><a href="tel:{{$phoneNo}}">{{$phoneNo}}</a></span></div>
                </div>
    ...
    <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
        <div class="container">
            <a class="navbar-brand" href="{{ asset('/') }}"><img src="{{$headerLogo}}" alt="" class="toplogo"> <span class="cname">Belvedere Union</span></a>
            ...
            <div class="collapse navbar-collapse justify-content-end xt-navbar-main-menu" id="navbarSupportedContent">
                <ul class="nav-menu nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item {{ request()->is('about') ? 'active' : '' }}
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ asset('about') }}">About Belvedere Union</a></li>
                            <li><a href="{{ asset('whyjoin') }}">Why Join</a></li>
                            <li><a href="{{ asset('committi') }}">Committee Members</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item {{ request()->is('sponser') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ asset('sponser') }}">Sponsor</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);">Donate</a>
                        <ul class="dropdown-menu">
                            <li><a href="javascript:void(0);">Belvedere Youth Club</a></li>
                            <li><a href="javascript:void(0);">Belvedere Benevolent Association</a></li>
                ...
                @guest
                <div class="reptro-header-profile-img singtop"> <a class="btn btn-lg btn-fill" href="{{route('auth-login')}}">Member Login</a>
                </div>
                @endauth
                @auth()
                    <div class="reptro-header-profile-img singtop"> <a class="btn btn-lg btn-fill" href="{{route('dashboard')}}">My Account</a>
                    </div>
                @endauth
            </div>
        </div>
