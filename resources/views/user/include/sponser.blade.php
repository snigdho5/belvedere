    <section class="OSponsors">
        ...
        <div class="container">
            ...
            <p class="section-title-small text-center  section-title-small-border-yes"><a href="{{ asset('sponsor') }}">Become a Sponsor</a> | <a href="javascript:void(0);">Sponsor Benefits</a></p>
