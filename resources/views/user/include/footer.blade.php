            ...
            <div class="row">
                ...
                <div id="text-2" class="col-lg-2 col-md-6">
                    ...
                    <div class="textwidget">
                        ...
                        <p style="overflow: hidden;"><img src="{{$footerLogo}}" alt="" class="toplogo"> </p>

                        <span class="cname">Belvedere Union</span>
                ...
                <div class="col-lg-3 col-md-6 widget widget_nav_menu">
                    ...
                    <div class="menu-footer-menu-container">
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="{{secure_url('/contactus')}}">Contact Us</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="reptro-cta-widget shadow">
                        ...
                        <!-- <div class="call-to-action-text">{{$footerDesc3}}</div>  -->

                         <div class="call-to-action-text">The Belvedere Union enables past pupils of Belvedere College to maintain friendships made at school, to help our members who are in need and to provide opportunities for Old Belvederians to connect with each other.</div> 

                        @guest

                            <a class="reptro-call-to-action-btn" href="javascript:void(0);" title="Join With Us">Join With Us</a>
