    ...
    <header class="xt-head-2">
        ...
        <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ secure_url('/') }}"><img src="{{$headerLogo}}" alt="" class="toplogo"> <span class="cname">Belvedere Union</span></a>
                    ...
                    <ul class="nav-menu nav navbar-nav navbar-right">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="https://www.belvedereyouthclub.ie/Donate/" target="_blank">Belvedere Youth Club</a></li>

                                <li><a href="{{ secure_url('belvederebenevolentassociation') }}">Belvedere Benevolent Association</a></li>
