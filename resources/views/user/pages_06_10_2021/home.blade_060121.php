...
<section>
    <div class="reptro-hero-area">
        ...
        <div class="reptro-hero-area-left reptro-hero-area-left-custom-bg-no reptro-hero-area-column">
            ...
            <p>already have an account?<a href="{{ asset('login') }}" style="color: white"> click here to Login.</a></p>
            ...
            <div class="wpcf7">
                ...
                <form id="form1" class="wpcf7-form init demo">
                    ...
                    <div class="xt_sign_up_now_field xt_sign_up_now_submit" id="testest"><input type="button" value="Next" disabled id="nexpay"></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class=" repto-button-border  elementor-widget-button"> <a href="{{ asset('about') }}" class=" elementor-button"> <span class="elementor-button-text">Read More</span> </a></div>
            </div>
            <div class="col-lg-6">
...
<section class="UEvents">
    <div class="container">
        ...
        <p class="section-title-small text-center  section-title-small-border-yes">Due to the current Covid 19 pandemic, there are currently no upcoming events.</p>
        ...
        <div class="text-center reptro-all-courses-btn"> <a class="btn btn-lg btn-fill" href="{{ asset('event') }}">All Events</a></div>
    </div>
</section>
...
<section class="LNews">
    <div class="container">
        ...
        <br>
    <div class="text-center reptro-all-courses-btn"> <a class="btn btn-lg btn-fill" href="{{ asset('News') }}">All News</a></div>
        ...
        <div class="row">
            <div class="reptro-ctl-area reptro-ctl-default">
                <div class="reptro-ctl-content-wrapper">
                    ...
                    <div class="reptro-ctl-button"> <a class="btn btn-lg btn-border" href="{{ asset('careers') }}">View All</a></div>
                </div>
            </div>
        </div>
    </div>
