...
<body>
  @include('user.include.header') 
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-sm-6">
                            <input type="email" name="your-email" value="" size="40" class="form-control" placeholder="Email">
                        </div>
                        <div class="form-group col-md-12">
                            <input type="text" name="your-subject" value="" size="40" class="form-control" placeholder="Subject">
                        </div>
                        <div class="form-group col-md-12"><textarea name="your-message" cols="40" rows="5" class="form-control materialize-textarea" placeholder="Message"></textarea>
                        </div>
                        <div class="form-btn col-md-12 text-center"> <input type="submit" value="Submit Your Query" class="btn btn-fill btn-big"></div>
                    </div>
                </div>
                <div class="offset-lg-1 col-lg-5 col-md-5 ">
                  <ul class="contact-info">
                            <li><span class="contact-info-icon"><i class="sli-location-pin"></i></span><span class="contact-info-content"><span class="contact-info-heading" style="color: #ee192b;">Location:</span><span class="contact-info-details">Belvedere College Union,<br> 6 Great Denmark Street, <br> Dublin 1, Ireland.</span></span></li>
                            <li><span class="contact-info-icon"><i class="sli-phone"></i></span><span class="contact-info-content"><span class="contact-info-heading" style="color: #ee192b;">Phone:</span><span class="contact-info-details">+353 1 858 6600</span></span></li>
                            <li><span class="contact-info-icon"><i class="sli-paper-plane"></i></span><span class="contact-info-content"><span class="contact-info-heading" style="color: #ee192b;">Email:</span><span class="contact-info-details"><a href="mailto:belvedereunion@belvederecollege.ie">belvedereunion@belvederecollege.ie</a></span></span></li>
                        </ul>
                </div>
            </div>
        </div>
    ...
    <section class="reptro-section-padding-large">
            <div class="text-center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2381.298410692117!2d-6.264683684614464!3d53.35581418170377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48670e875b8fc64d%3A0xdfdfb77edc940a56!2sBelvedere%20College%20SJ!5e0!3m2!1sen!2sin!4v1598726581259!5m2!1sen!2sin" width="100%" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
    </section>
    <!-- ********footer********** -->
