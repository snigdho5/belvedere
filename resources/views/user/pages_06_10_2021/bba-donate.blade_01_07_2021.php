            ...
            <div class="col-lg-6">
                <div class="xt-video xt-video-popup-type-with_image">
                    ...
                    <div class="donationdiv">
                        ...
                        <form method="post">
                            <label>€</label>
                            <input id="donateamt" type="text" placeholder="Enter Donation Amount" name="amount" onkeypress="return isNumber(event)" />
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="donatenow">
                    <input type="hidden" name="payerID" id="payerIDdonate">
                    <input type="hidden" name="orderID" id="orderIDdonate">
                    ...
                    <div class="form-group">
                        ...
                        <input id="amount" type="hidden" name="donation"/>
                    </div>
                    <div class="form-group">
        ...
        paypal.Buttons({
            ...
            createOrder: function(data, actions){
                ...
                return actions.order.create({
                    application_context: {
                        brand_name: 'Belender Donation CheckOut',
                        user_action: 'PAY_NOW',
                    },
                    purchase_units: [{
                        amount: {
...
<script>
    ...
    $(document).on('click','#confirmDont'.function(){
