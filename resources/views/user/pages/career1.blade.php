                ...
                @foreach ($data as $item)
                    ...
                    <li class="course  col-lg-12 col-md-12">
                        <div class="reptro-course-loop-thumbnail-area">
                            ...
                            <div class="course-thumbnail"> <img width="570" height="461" src="user/images/rawpixel.jpg">
                            </div>
                        </div>
                        <div class="reptro-course-item-inner"> <a href="#" class="course-permalink">
                            ...
                            <div class="event-info">
                                ...
                                <div class="venueTime">
                                    ...
                                    <span class="reptro-event-venue"><i
                                            class="sli-location-pin"></i>{{ $item->location }}</span>
