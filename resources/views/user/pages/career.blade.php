                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-field_new">
                                        ...
                                        <input id="search_new" class="search_new" name="query" type="text" placeholder="Enter Keywords" />
                                ...
                                <div class="modal-body">
                                    <form id="applyforjob" class="applyforjob">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="applicant_email" id="applicantemail" required>
                                        </div>                                        
                                        <div class="form-group">
                                            <label for="job_description">Your Phone No.</label>
                                            <input type="text" class="form-control" name="applicant_phone" id="applicantphone" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="company_logo">Your CV</label>
                                            <input type="file" class="form-control" name="applicant_cv" required/>
                                        </div>
                                        <button type="submit" class="btn btn-apply btn-default">Apply</button>
                                        
                                        <label class="show-msg"></label>
                                    </form>
                                </div>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.id != 0){
                    ...
                    //$('#myModal').modal('hide');  
                    $('.show-msg').html('Successfully submitted!');
