...
<div class="row clearfix">
    ...
    <div class="col-lg-4 col-md-12">
            ...
            <div class="body">
                <article class="media">
                    ...
                    <div class="media-body">
                        <div class="content">
                        <p class="h5">John Smith <small>@johnsmith</small> <small class="float-right text-muted font-12">31 minutes ago</small></p>
        ...
        <div class="card">
            <div class="body">
                <div class="mb-2 status text-danger">Missing Success URL</div>
                <div class="mb-2 status text-warning status-animated">Waiting in queue</div>
                <div class="mb-2 status text-success">Everything is ready</div>
    ...
    <div class="col-lg-4 col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="javascript:void(0)" class="btn btn-primary theme-bg">Go somewhere</a>
            </div>
        </div>
        <form class="card" action="" method="post">
            ...
            <div class="body">
                ...
                <div class="form-group c_form_group">
                    <label class="form-label d-block">Password<a href="javascript:void(0);" class="float-right small">I forgot password</a></label>
                ...
                <div class="form-footer">
                    <button type="submit" class="btn btn-primary theme-bg btn-block">Sign in</button>
                </div>
            </div>
        </form>
        <div class="card">
