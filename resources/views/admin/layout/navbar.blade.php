            ...
            <div class="navbar-right">
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <!--<li><a href="{{url('authentication.login')}}" class="icon-menu"><i class="fa fa-power-off"></i></a></li>-->
                        <li><a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="icon-menu"><i class="fa fa-power-off"></i></a></li>
