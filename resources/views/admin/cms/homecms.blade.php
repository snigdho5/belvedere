            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="body">
                        ...
                        <form action="cms/addeditcms" id="myForm" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="form-group c_form_group">
                                        ...
                                        <div class="">
                                            <textarea class="form-control" id="ckeditor" name="description"
                                                aria-label="With textarea">{{ isset($data->description) ? $data->description : '' }}</textarea>
                                        </div>
