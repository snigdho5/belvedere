        ...
        <div class="card">
            ...
            <div class="body">
                <div class="body">
                    ...
                    <form action="cms/aboutadded" id="myForm" method="post">
                        @csrf
                        <div class="row">
                                <input type="hidden" name="page_type" value="committee">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="video_link" name="video_link" value="{{isset($data->title)?$data->title:''}}">
                                    </div>
                                    <span id="title_error" class="error"></span>
                                </div>
                            </div>
