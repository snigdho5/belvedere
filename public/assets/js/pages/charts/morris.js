...
function MorrisArea() {
    Morris.Area({
        ...
        pointSize: 1,
        fillOpacity: 0.3,
        pointStrokeColors: ['#2c83b6', '#61bda1'],
        behaveLikeLine: true,
        gridLineColor: '#efefef',
        lineWidth: 0,
        smooth: false,
        hideHover: 'auto',
        lineColors: ['#2c83b6', '#61bda1'],
        resize: true
    ...
    Morris.Area({
        ...
        pointSize: 2,
        fillOpacity: 0.1,
        pointStrokeColors: ['#2c83b6', '#61bda1', '#a5d8a2'],
        behaveLikeLine: true,
        gridLineColor: '#efefef',
        lineWidth: 1,
        hideHover: 'auto',
        lineColors: ['#2c83b6', '#61bda1', '#a5d8a2'],
        resize: true
    ...
    Morris.Area({
        ...
        lineColors: ['#2c83b6', '#61bda1', '#a5d8a2'],
        xkey: 'period',
        ykeys: ['iphoneX', 'MI10', 'oneplus'],
        labels: ['iphoneX', 'MI10', 'oneplus'],
        pointSize: 2,
        lineWidth: 0,
        resize: true,
        fillOpacity: 1,
...
function MorrisBarChart() {
    Morris.Bar({
        ...
        ykeys: ['a', 'b', 'c'],
        labels: ['A', 'B', 'C'],
        barColors: ['#2c83b6', '#a5d8a2', '#3C89DA'],
        hideHover: 'auto',
        gridLineColor: '#efefef',
        resize: true
    });
